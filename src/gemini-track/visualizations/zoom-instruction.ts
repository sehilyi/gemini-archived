...
export function drawZoomInstruction(HGC: any, trackInfo: any) {
  if (!trackInfo.zoomInstruction) {
    ...
    trackInfo.zoomInstruction = new HGC.libraries.PIXI.Text(
  ...
  // text
  trackInfo.zoomInstruction.x =
    trackInfo.position[0] + trackInfo.dimensions[0] / 2;
  trackInfo.zoomInstruction.y =
    trackInfo.position[1] + trackInfo.dimensions[1] / 2;
