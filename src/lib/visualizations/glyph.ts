    ...
    if (markE === "line") {
      ...
      g.selectAll()
        ...
        .attr(
          "y",
          (d) =>
            tm.getEncoding(element, "y", d) -
            tm.getEncoding(element, "size", d) / 2.0
        )
        .attr(
          "width",
          (d) =>
            tm.getEncoding(element, "xe", d) - tm.getEncoding(element, "x", d)
        )
      ...
      g.selectAll()
        ...
        .attr(
          "x",
          (d) =>
            (tm.getEncoding(element, "x", d) +
              tm.getEncoding(element, "xe", d)) /
            2.0
        )
